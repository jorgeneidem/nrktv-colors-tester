    ...
    _createClass(FastAverageColor, [
      ...
      },
      {
        ...
        value: function getColor(resource, options) {
          ...
          if (!this._ctx) {
            ...
            this._ctx =
              this._canvas.getContext && this._canvas.getContext("2d");

            if (!this._ctx) {
              return this._prepareResult(
                defaultColor,
                new Error(
                  "FastAverageColor: Canvas Context 2D is not supported in this browser."
                )
              );
            }
          }
          ...
          try {
            ...
            var bitmapData = this._ctx.getImageData(
              0,
              0,
              size.destWidth,
              size.destHeight
      ...
      },
      {
        ...
        value: function _dominantAlgorithm(arr, len, preparedStep) {
          ...
          var buffer = Object.keys(colorHash)
            .map(function(key) {
        ...
        value: function _bindImageEvents(resource, callback, options) {
          ...
          var data = options && options.data,
            ...
            onerror = function onerror() {
              ...
              callback.call(
                resource,
                _this._prepareResult(defaultColor, new Error("Image error")),
                data
              );
            },
            onabort = function onabort() {
              ...
              callback.call(
                resource,
                _this._prepareResult(defaultColor, new Error("Image abort")),
                data
              );
            },
